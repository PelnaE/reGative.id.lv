...
Class Controller_Article Extends Controller_Template {
    ...
    public function action_index() {
        ...
        $mysql_respnse = Model::factory('article')->get_article($slug); //Meklē rakstu ar attiecīgu slug'u :D
        $id_get = Model::factory('article')->get_id($slug); //Šitais meklē pēc 'slug' raksta identifikācijas kodu
        if ($mysql_respnse) {
